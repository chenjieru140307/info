...
![](http://images.iterate.site/blog/image/20190702/vV97V9PNVP5N.png?imageslim){ width=55% }
...
![](http://images.iterate.site/blog/image/20190702/dRhIL7QATDue.png?imageslim){ width=55% }

*Table 4*

一旦计算了哈希值，我们可以将每个项插入到指定位置的哈希表中，如 Figure 5 所示。注意，11 个插槽中的 6 个现在已被占用。这被称为负载因子，通常表示为 `λ=项数/表大小`, 在这个例子中，`λ = 6/11` 。
![](http://images.iterate.site/blog/image/20190702/aH41xSuIJsfA.png?imageslim){ width=55% }
...
![](http://images.iterate.site/blog/image/20190702/MdY1uQE8sVry.png?imageslim){ width=55% }
...
![](http://images.iterate.site/blog/image/20190702/d9Yl9OvwMpoj.png?imageslim){ width=55% }
...
![](http://images.iterate.site/blog/image/20190702/ONuffYjdjvxK.png?imageslim){ width=55% }
...
![](http://images.iterate.site/blog/image/20190702/EQ4utkJRgGLs.png?imageslim){ width=55% }
...
![](http://images.iterate.site/blog/image/20190702/J1dED90nFVXc.png?imageslim){ width=55% }
...
![](http://images.iterate.site/blog/image/20190702/WJaGwfulGFb3.png?imageslim){ width=55% }
...
![](http://images.iterate.site/blog/image/20190702/Nv7cyurzxmqw.png?imageslim){ width=55% }
...
![](http://images.iterate.site/blog/image/20190702/W8wlw2pxr7jF.png?imageslim){ width=55% }
