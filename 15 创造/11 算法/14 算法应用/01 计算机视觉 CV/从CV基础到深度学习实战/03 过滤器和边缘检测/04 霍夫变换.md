...
![](http://images.iterate.site/blog/image/180809/Ea28FfbhGj.png?imageslim){ width=55% }


![](http://images.iterate.site/blog/image/180809/kCLCCf30Li.png?imageslim){ width=55% }
...
![](http://images.iterate.site/blog/image/180809/CigmldjhAm.png?imageslim){ width=55% }
...
![](http://images.iterate.site/blog/image/180809/EIFcc1c347.png?imageslim){ width=55% }
...
![](http://images.iterate.site/blog/image/180809/8A08616A12.png?imageslim){ width=55% }

我们在 Hough 空间投票得到这样的一个曲线：

![](http://images.iterate.site/blog/image/180809/3cBFhKcHD9.png?imageslim){ width=55% }
...
![](http://images.iterate.site/blog/image/180809/mCH5f1J4kC.png?imageslim){ width=55% }
...
- HOUGH_STANDARD cv::HoughLines ![](http://images.iterate.site/blog/image/180809/LHgL1GIajb.png?imageslim){ width=55% }
- HOUGH_PROBABILISTIC ![](http://images.iterate.site/blog/image/180809/CaDbgHIeCI.png?imageslim){ width=55% }
...
![](http://images.iterate.site/blog/image/180809/B0bg3kbdb8.png?imageslim){ width=55% }
...
![](http://images.iterate.site/blog/image/180809/38GdKcE3em.png?imageslim){ width=55% }
...
![](http://images.iterate.site/blog/image/180809/jk5jL0Fig5.png?imageslim){ width=55% }
...
![](http://images.iterate.site/blog/image/180809/1CbbDh2kie.png?imageslim){ width=55% }

但是你仍然可以看到中间的这些点还是可以看见的，因为它使用了滤镜。这个是日本的农机公司做的一个自动车辆上面的要对这种进行处理的。通过 hough 变换来提供一些导航信息。

![](http://images.iterate.site/blog/image/180809/3L1l48FkkE.png?imageslim){ width=55% }

这个东西是插秧机，目前他用的是 GPS 导航，放在最上面的位置，舵是自动舵，

人手动开第一个位置：

![](http://images.iterate.site/blog/image/180809/g111hkC4ck.png?imageslim){ width=55% }

开出一个基准线：

![](http://images.iterate.site/blog/image/180809/3179c30kfh.png?imageslim){ width=55% }

转弯目前也不是自动转弯，但是转弯之后的行走是自动行走的，

![](http://images.iterate.site/blog/image/180809/iD0m7EhC0b.png?imageslim){ width=55% }

大家注意最右侧的一个小轮子，就是最右侧白色支架支出去的在地上划线的小轮子：

![](http://images.iterate.site/blog/image/180809/Jg5J7HcCmG.png?imageslim){ width=55% }
