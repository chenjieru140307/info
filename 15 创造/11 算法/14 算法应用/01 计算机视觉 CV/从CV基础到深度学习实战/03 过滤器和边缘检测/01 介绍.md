...
![](http://images.iterate.site/blog/image/180806/k6Je347dhI.png?imageslim){ width=55% }

![](http://images.iterate.site/blog/image/180806/elm5L12kLL.png?imageslim){ width=55% }
...
![](http://images.iterate.site/blog/image/180806/i7HFafD6Ah.png?imageslim){ width=55% }

滑动平均窗口

下面我们举个例子：

![](http://images.iterate.site/blog/image/180806/G9gDAffahC.png?imageslim){ width=55% }

![](http://images.iterate.site/blog/image/180806/iGAb9jifmF.png?imageslim){ width=55% }

![](http://images.iterate.site/blog/image/180806/HfKef4cidK.png?imageslim){ width=55% }

![](http://images.iterate.site/blog/image/180806/k7Dkif5baL.png?imageslim){ width=55% }

![](http://images.iterate.site/blog/image/180806/e3I6Jhc1al.png?imageslim){ width=55% }

$$h[m,n]=\sum_{k,l}^{}g[k,l]f[m+k,n+l]$$


![](http://images.iterate.site/blog/image/180806/8LAH5fldCl.png?imageslim){ width=55% }
...
![](http://images.iterate.site/blog/image/180806/DFgbm8gD4g.png?imageslim){ width=55% }
...
![](http://images.iterate.site/blog/image/180806/GEflfLBge1.png?imageslim){ width=55% }

在 opencv 中，这种滑动平均的两种实现方式：Blur() 和 boxFilter()

![](http://images.iterate.site/blog/image/180806/2J1Iimh0dj.png?imageslim){ width=55% }
...
![](http://images.iterate.site/blog/image/180806/H2DidDb0fD.png?imageslim){ width=55% }
...
![](http://images.iterate.site/blog/image/180806/lGJl041fA2.png?imageslim){ width=55% }

![](http://images.iterate.site/blog/image/180806/EeAJAhjm73.png?imageslim){ width=55% }
...
![](http://images.iterate.site/blog/image/180806/AjgcKgK0lG.png?imageslim){ width=55% }
...
![](http://images.iterate.site/blog/image/180806/8dgaffCBCI.png?imageslim){ width=55% }

box filter 效果如下：

![](http://images.iterate.site/blog/image/180806/1AJb7I41II.png?imageslim){ width=55% }
...
- OpenCV: filter2D()
![](http://images.iterate.site/blog/image/180806/9IACg6LbaE.png?imageslim){ width=55% }
...
![](http://images.iterate.site/blog/image/180806/46l8D45633.png?imageslim){ width=55% }

可见，如果使用的是均值滤波器，可以看到这个异常值对于处理后的图像还是有影响的，但是对于中值滤波器，是完全没有影响的。

中值滤波器到底是什么样的呢？

![](http://images.iterate.site/blog/image/180806/C6bmJLDlcb.png?imageslim){ width=55% }

![](http://images.iterate.site/blog/image/180806/455hH4d58d.png?imageslim){ width=55% }

看一下中值滤波器对于椒盐噪声的图像的处理：

![](http://images.iterate.site/blog/image/180806/7jLHcDJf3E.png?imageslim){ width=55% }
...
![](http://images.iterate.site/blog/image/180806/7ciaIJjBcC.png?imageslim){ width=55% }

![](http://images.iterate.site/blog/image/180806/dH74DljIha.png?imageslim){ width=55% }

它是做得刚体的形变的，比如说，一个刚体，我们给表面喷洒一些散斑，然后在它受力的过程中一直拍摄这个表面的形变，通过我们对图像做相关运算，可以算出这个物体的表面的位移以及应变场等。 这个是在力学中的一个非常典型的应用。它的试验设备是什么样的呢？

![](http://images.iterate.site/blog/image/180806/IJD103ICl1.png?imageslim){ width=55% }
