...
这个 Data alignment features（数据对齐特色）和数据库中的 join 相似。==为什么这个 + 是 join 操作呢？看起来有些奇怪==
...
![](http://images.iterate.site/blog/image/180616/7AIEDkC9Hk.png?imageslim){ width=55% }
...
![](http://images.iterate.site/blog/image/180616/9iiikFcKll.png?imageslim){ width=55% }
