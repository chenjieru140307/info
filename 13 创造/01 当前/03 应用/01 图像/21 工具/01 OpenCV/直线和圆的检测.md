...
![](http://images.iterate.site/blog/image/181106/04fj4E2aaG.png?imageslim){ width=55% }
...
![](http://images.iterate.site/blog/image/181106/f27JDG5G5g.png?imageslim){ width=55% }
...
![](http://images.iterate.site/blog/image/181106/CHi2EA2402.png?imageslim){ width=55% }

ok前面说的是单单这一个点对应的极坐标系下的参数对，那么如果每个点都这么找一圈呢？也就是每个点在参数空间上都对应一系列参数对吧，现在把它们华仔同一个坐标系下会怎么样呢？为了方便，假设在这个直线上取 3 个点画一下：

![](http://images.iterate.site/blog/image/181106/8gfm2G6jg7.png?imageslim){ width=55% }
...
![](http://images.iterate.site/blog/image/181106/E532B2HdgF.png?imageslim){ width=55% }

测试一个新的图，不停的改变 cv2.HoughLines最后一个阈值参数到合理的时候如下：

![](http://images.iterate.site/blog/image/181106/1hDKF0I3I8.png?imageslim){ width=55% }
...
![](http://images.iterate.site/blog/image/181106/gihk71fCJJ.png?imageslim){ width=55% }
...
![](http://images.iterate.site/blog/image/181106/EBhE4ALi8h.png?imageslim){ width=55% }


把半径范围调小点，检测内圆：

![](http://images.iterate.site/blog/image/181106/lalhDgik69.png?imageslim){ width=55% }
