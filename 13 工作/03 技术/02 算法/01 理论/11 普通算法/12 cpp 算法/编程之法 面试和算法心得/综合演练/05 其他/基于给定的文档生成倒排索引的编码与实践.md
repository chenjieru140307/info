...
![](http://images.iterate.site/blog/image/180708/A2k13kDcim.jpg?imageslim){ width=55% }
...
![](http://images.iterate.site/blog/image/180708/iIJ45Fg1mh.jpg?imageslim){ width=55% }

要求基于给定的上述正排文档。生成如第二十四章所示的倒排索引文件（注，关键词所在的文章如果是同一个日期的话，是挨在同一行的，用“#”符号隔开）：
![](http://images.iterate.site/blog/image/180708/B87ej61gKD.jpg?imageslim){ width=55% }

我们知道：为网页建立全文索引是网页预处理的核心部分，包括分析网页和建立倒排文件。二者是顺序进行，先分析网页，后建立倒排文件（也称为反向索引），如图所示：

![](http://images.iterate.site/blog/image/180708/bh8jiJK5AG.jpg?imageslim){ width=55% }
...
![](http://images.iterate.site/blog/image/180708/imDciI5AIH.jpg?imageslim){ width=55% }
...
![](http://images.iterate.site/blog/image/180708/B8F2ABk9EA.jpg?imageslim){ width=55% }

也就是说，上面建索引的过程本该是如下的：
![](http://images.iterate.site/blog/image/180708/lk0hE2hBb0.jpg?imageslim){ width=55% }
...
![](http://images.iterate.site/blog/image/180708/CF6H5Eha7d.jpg?imageslim){ width=55% }

### 为关键词添上编码

如上图所示，已经满足需求了。但可以再在每个关键词的背后添加一个计数表示索引到了第多少个关键词：
![](http://images.iterate.site/blog/image/180708/4DCdfh399B.jpg?imageslim){ width=55% }
...
![](http://images.iterate.site/blog/image/180708/kfKCddFG2D.jpg?imageslim){ width=55% }
